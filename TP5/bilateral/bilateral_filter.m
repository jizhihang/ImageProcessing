...
for i = 1:Len(1)
         ...
         iMin = max(i-N,1);
         iMax = min(i+N,Len(1)); %taille de la fenêtre variable en fonction de la proximité avec les bords
   ...
   for j = 1:Len(2)
         ...
         I = In(iMin:iMax,jMin:jMax,:); %fenêtre glissante
         ...
         norm_tmp = sum(tmp(:)); %fonction de normalisation
